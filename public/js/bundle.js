...
},{}],"sidebarHandler.js":[function(require,module,exports) {
...
if (sideBar) {
  sideBarItems.forEach(function (el) {
    ...
    var link = document.createTextNode("".concat(el.title));
    ...
    anchor.href = "".concat(el.path);
    sideBar.appendChild(anchor);
  });
  var span = document.createElement("span");
  span.className = "p-4 text-xs block cursor-pointer uppercase bg-red-500 text-white";
  span.innerText = "Logout";
  sideBar.appendChild(span);
  span.addEventListener("click", function () {
    var js = jsCookie.remove("jwt", {
      path: "/"
    });
    console.log(js);
...
},{"js-cookie":"../../node_modules/js-cookie/dist/js.cookie.js"}],"tiny.js":[function(require,module,exports) {
window.tinymce.init({
  selector: "#tinymce",
...
window.onload = function () {
  setTimeout(function () {
    console.log("hii");
    window.tinymce.activeEditor.getBody().innerHTML = document.getElementById("tinymce").innerText;
  }, 2000);
};
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"_services.js":[function(require,module,exports) {
"use strict";
...
var getHeaders = function getHeaders() {
  return {
    authorization: _jsCookie.default.get("jwt")
  };
};

exports.getHeaders = getHeaders;
},{"js-cookie":"../../node_modules/js-cookie/dist/js.cookie.js"}],"_markup.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports._alertmarkup = void 0;
var _alertmarkup = "\n    <div id=\"alert-box\" class=\"animate__animated animate__slideInUp animate__faster fixed bottom-5 right-5 ring-%COLOR%-500 z-10  max-w-64 bg-white rounded-md shadow-xl p-4 m-10 text-sm text-%COLOR%-600 ring-1  \">\n      <p class=\"text-sm\">%MESSAGE%</p>\n    </div>";
...
},{"./_markup":"_markup.js"}],"blogService.js":[function(require,module,exports) {
"use strict";
...
var description = document.getElementById("blog_description");
var poster = document.getElementById("blog_poster");
var posterLabel = document.getElementById("blog_poster_label");
var posterPreview = document.getElementById("blog_poster_preview");
var saveBtn = document.getElementById("save-editor");
var editBtn = document.getElementById("edit-editor");

if (poster) {
  poster.addEventListener("change", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return _axios.default.post("/api/v1/upload", formData);
...
if (saveBtn) {
  saveBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var body, titleValue, descriptionValue, blogData, _yield$axios$post2, _data;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            body = window.tinymce.activeEditor.getContent();
            ...
            if (!(!blogData.title || !blogData.description || !blogData.poster || !blogData.body)) {
              _context2.next = 8;
              break;
            }

            (0, _alert.showAlert)("Invalid details", _alert.alertType[1]);
            return _context2.abrupt("return");

          case 8:
            saveBtn.innerText = "Please wait...";
            _context2.next = 11;
            return _axios.default.post("/api/v1/blog", blogData, {
              headers: (0, _services.getHeaders)()
            });
          ...
          case 11:
            ...
            (0, _alert.showAlert)(_data.message || "something wrong happened", _alert.alertType[1]);
            return _context2.abrupt("return");

          case 16:
            saveBtn.innerText = "Save";
            (0, _alert.showAlert)("Blog created successfully", _alert.alertType[0]);
            _context2.next = 24;
            break;
...
if (editBtn) {
  editBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var body, titleValue, descriptionValue, blogData, _yield$axios$put, _data2;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            _context3.next = 11;
            return _axios.default.put("/api/v1/blog/".concat(editBtn.dataset.id), blogData, {
              headers: (0, _services.getHeaders)()
            });
          ...
          case 11:
            ...
            (0, _alert.showAlert)("Blog edited successfully", _alert.alertType[0]);
            _context3.next = 21;
            break;
          ...
          case 17:
            ...
            (0, _alert.showAlert)(data.message || "something wrong happened", _alert.alertType[1]);
            editBtn.innerText = "Edit";
...
var blogListContainer = document.getElementById("blog_list_container");

if (blogListContainer) {
  blogListContainer.addEventListener("click", /*#__PURE__*/function () {
              ...
              try {
                if (e.target.dataset.id) {
                  ...
                  if (e.target.dataset.action === "edit") {
                    window.location.assign("/admin/edit/".concat(e.target.dataset.id));
                  } else {
                    _axios.default.delete("/api/v1/blog/".concat(e.target.dataset.id), {
                      headers: (0, _services.getHeaders)()
                    });

                    (0, _alert.showAlert)("Blog deleted successfully", _alert.alertType[0]);
                    setTimeout(function () {
                      window.location.reload();
                    }, 1500);
                  }
                ...
                (0, _alert.showAlert)("something wrong happened", _alert.alertType[1]);
              }
...
},{"axios":"../../node_modules/axios/index.js","./_services":"_services.js","./alert":"alert.js"}],"login.js":[function(require,module,exports) {
"use strict";
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return _axios.default.post("/api/v1/auth/login", userData);
            ...
            case 10:
              ...
              loginBtn.innerText = "Sign In";
              (0, _alert.showAlert)(_context.t0.response.data.message, _alert.alertType[1]);
